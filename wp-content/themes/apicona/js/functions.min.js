...
jQuery(document).ready(function($) {
    ...
    var teamSearchBoxIconOpen = 'kwicon-' + jQuery('.kwayy-team-search-btn > a').data('openicon');
    var teamSearchBoxIconClosed = 'kwicon-' + jQuery('.kwayy-team-search-btn > a').data('closeicon');
    ...
    $('.site-header .social-icons li a').tooltip({
        'placement': 'bottom'
    });
    $('.site-footer .social-icons li a').tooltip({
        'placement': 'bottom'
    });
    $('.kwayy-pf-navbar-wrapper a').tooltip({
        'placement': 'top'
    });
    $('.kwayy-clients a').tooltip({
        'placement': 'top'
    });
    ...
    if (jQuery('.kwayy-effect-carousel').length > 0) {
      ...
      "<i class='icon-chevron-right icon-white'>></i>"
                        ...
                        carousel.trigger('owl.play', 4500);
