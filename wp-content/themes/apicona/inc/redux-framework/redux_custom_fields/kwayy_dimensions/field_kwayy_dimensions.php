<?php
    ...
    if ( ! class_exists( 'ReduxFramework_kwayy_dimensions' ) ) {
        class ReduxFramework_kwayy_dimensions {
            ...
            function render() {
				...
				echo '
					<strong>' . __( 'Hard Crop Image?', 'howes' ) . '</strong>
					 &nbsp; 
					<label class="radio inline">
						...
						<!--<input type="radio" name="' . $this->field['name'] . $this->field['name_suffix']. '[crop]' . '" id="' . $this->field['id'] . '-crop-yes" value="yes" ' . checked( $this->value['crop'], yes, false ) . '> -->
						YES
					</label>
					 &nbsp; 
					<label class="radio inline">
						...
						<!--<input type="radio" name="' . $this->field['name'] . $this->field['name_suffix']. '[crop]' . '" id="' . $this->field['id'] . '-crop-no" value="no" ' . checked( $this->value['crop'], $k, false ) . '> -->
						NO
					</label>
            ...
            function enqueue() {
                ...
                //if ($this->parent->args['dev_mode']) {
                    wp_enqueue_style(
						...
						get_template_directory_uri() . '/inc/redux-framework/redux_custom_fields/kwayy_dimensions/field_kwayy_dimensions.css',
                        array(),
                        time(),
                        'all'
                    );
