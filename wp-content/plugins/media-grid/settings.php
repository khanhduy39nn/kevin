    ...
    <div id="layout_opt"> 
        ...
        <table class="widefat lcwp_table">
          <tr>
            ...
            <td class="lcwp_field_td">
                <select name="mg_pag_style" class="lcweb-chosen" data-placeholder="<?php _e("Select a style", 'mg_ml'); ?> .." tabindex="2">
          ...
          <tr>
            ...
            <td class="lcwp_field_td">
                <select name="mg_pag_align" class="lcweb-chosen" data-placeholder="<?php _e("Select an option", 'mg_ml'); ?> .." tabindex="2">
          ...
          <tr>
            ...
            <td class="lcwp_field_td">
                <select name="mg_pag_layout" class="lcweb-chosen" data-placeholder="<?php _e("Select a layout", 'mg_ml'); ?> .." tabindex="2">
				  <?php	
        ...
        <table class="widefat lcwp_table">
          <tr>
            <td class="lcwp_label_td"><?php _e("Transition effect", 'mg_ml'); ?></td>
            <td class="lcwp_field_td">
                <select name="mg_inl_slider_fx" class="lcweb-chosen" data-placeholder="<?php _e("Select a transition", 'mg_ml'); ?> .." tabindex="2">
				  <?php	
