...
?>
    ...
    <div id="mg_popup_container" style="display:none;">
	  ...
	  ?>
          ...
          <tr>
            ...
            <td><span class="info"><?php _e('Moves titles under items', 'mg_ml') ?></span></td>
          </tr>
          <tr>
          ...
          <tr class="mg_scw_ff" style="display: none;">
            <td><?php _e('Filters position', 'mg_ml') ?></td>
      		<td class="lcwp_form" colspan="2">
            	<select id="mg_filters_align" data-placeholder="<?php _e('Select an overlay', 'mg_ml') ?> .." name="mg_filters_align" class="lcweb-chosen" style="width: 370px;">
	...
	foreach($grids as $grid) {
		...
		$filters = mg_grid_terms_data($grid_data['cats'], $return = 'array');
